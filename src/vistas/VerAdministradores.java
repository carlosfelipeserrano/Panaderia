 ...
 * @author carlo
 */
public class VerAdministradores extends javax.swing.JFrame {
     ...
     */
    public VerAdministradores() {
        initComponents();

        jTableAdmin.setRowHeight(30);

        jTableAdmin.setShowGrid(true);
        jTableAdmin.setGridColor(Color.white);
        jTableAdmin.setSelectionBackground(Color.gray);
        jTableAdmin.setBackground(black);
        jTableAdmin.getTableHeader().setForeground(new Color(0, 0, 0));
        jTableAdmin.getTableHeader().setFont(new Font("Agency FB", Font.BOLD, 18));
        txtrutadmin.setBackground(new java.awt.Color(0, 0, 0, 1));
        ...
        jTableAdmin.getColumnModel().getColumn(columna).setPreferredWidth(anchoDeseado);
        ...
        int anchoDeseadoo = 60; // El ancho deseado para la celda en píxeles (valor más pequeño)

        jTableAdmin.getColumnModel().getColumn(columnaa).setPreferredWidth(anchoDeseadoo);
        ...
        jTableAdmin.getColumnModel().getColumn(columnaaa).setPreferredWidth(anchoDeseadooo);
        ...
        int anchoDeseadoooo = 90; // El ancho deseado para la celda en píxeles (valor más pequeño)

        jTableAdmin.getColumnModel().getColumn(columnaaaa).setPreferredWidth(anchoDeseadoooo);
        ...
        jTableAdmin.getColumnModel().getColumn(columnaaaaa).setPreferredWidth(anchoDeseadooooo);
        ...
        jTableAdmin.getColumnModel().getColumn(columnaaaaaa).setPreferredWidth(anchoDeseadoooooo);
        ...
        jTableAdmin.getColumnModel().getColumn(columnaaaaaaa).setPreferredWidth(anchoDeseadooooooo);
        Limpiar();
    ...
    public void admin() {
        ...
        DefaultTableModel modelo = logica.mostrarAdministradores();

        jTableAdmin.setModel(modelo);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 40, 150, 80));

        jLabel9.setFont(new java.awt.Font("Agency FB", 1, 36)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("Administradores Registrados");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 40, 390, 50));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 110, 50));

        jPanel3.setBackground(new java.awt.Color(235, 112, 19));

        btnadminreg.setBackground(new java.awt.Color(235, 112, 19));
        btnadminreg.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        btnadminreg.setForeground(new java.awt.Color(0, 0, 0));
        btnadminreg.setText("Buscar");
        btnadminreg.setToolTipText("");
        btnadminreg.setBorder(null);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addComponent(btnadminreg, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(btnadminreg, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 120, -1, 40));
        ...
        jPanel1.add(header1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1340, 30));

        jTableAdmin.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        jTableAdmin.setForeground(new java.awt.Color(255, 255, 255));
        jTableAdmin.setSelectionBackground(new java.awt.Color(255, 255, 255));
        jTableAdmin.setSelectionForeground(new java.awt.Color(0, 0, 0));
        jScrollPane1.setViewportView(jTableAdmin);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 300, 1190, 530));

        txtrutadmin.setBackground(new java.awt.Color(255, 255, 255));
        txtrutadmin.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        txtrutadmin.setForeground(new java.awt.Color(255, 255, 255));
        txtrutadmin.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtrutadmin.setActionCommand("<Not Set>");
        txtrutadmin.setBorder(null);
        txtrutadmin.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        txtrutadmin.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        txtrutadmin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtrutadminMousePressed(evt);
            }
        });
        ...
        txtrutadmin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtrutadminKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtrutadminKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtrutadminKeyTyped(evt);
            }
        });
        jPanel1.add(txtrutadmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 160, 30));
        jPanel1.add(jsusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 160, 10));
        ...
        jPanel1.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 240, -1, -1));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, -1, -1));
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 240, 120, 50));
        ...
        loginBtn4.setText("Modificar Datos del Administrador");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addComponent(loginBtn4, javax.swing.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, 310, 50));
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 240, 110, 50));

        jLabel1.setBackground(new java.awt.Color(0, 0, 0));
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ayu.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1340, 850));
    ...
    private void txtrutadminMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtrutadminMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtrutadminMousePressed
    ...
    private void txtrutadminKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtrutadminKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtrutadminKeyPressed
    ...
    private void txtrutadminKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtrutadminKeyTyped
        // TODO add your handling code here:
        ...
        if (txtrutadmin.getText().length() >= 12) {
            evt.consume();
            JOptionPane.showMessageDialog(null, "Sólo se debe ingresar como máximo 12 caracteres");
            return;
        }

        if (txtrutadmin.getText().length() == 2 || txtrutadmin.getText().length() == 6) {
            txtrutadmin.setText(txtrutadmin.getText() + '.');
        } else if (txtrutadmin.getText().length() == 10) {
            txtrutadmin.setText(txtrutadmin.getText() + '-');
        }
    }//GEN-LAST:event_txtrutadminKeyTyped
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            consultas.exportarExcel(jTableAdmin);
    ...
    private void loginBtn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtn3ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(VerAdministradores.class.getName()).log(Level.SEVERE, null, ex);
        }
        f1.setVisible(true);
    ...
    private void loginBtn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtn4ActionPerformed
        // TODO add your handling code here:
        Consulta consultas = new Consulta();
        String Hallulla = jTableAdmin.getValueAt(jTableAdmin.getSelectedRow(), 7).toString();
        ...
        if (selectedRow >= 0) {
            int modelRow = jTableAdmin.convertRowIndexToModel(selectedRow);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerAdministradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VerAdministradores().setVisible(true);
        });
    }
