...
public class Pedido extends javax.swing.JFrame {
    ...
    public Pedido() {
        ...
        jTablePedidos.setGridColor(Color.white);
        jTablePedidos.setSelectionBackground(Color.gray);
        jTablePedidos.setBackground(black);
        jTablePedidos.getTableHeader().setForeground(new Color(0, 0, 0));
        jTablePedidos.getTableHeader().setFont(new Font("Agency FB", Font.BOLD, 18));
    ...
    private void initComponents() {
        ...
        jPanel1.add(header1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1510, 30));

        jTablePedidos.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        jTablePedidos.setForeground(new java.awt.Color(255, 255, 255));
        jTablePedidos.setSelectionBackground(new java.awt.Color(255, 255, 255));
        jTablePedidos.setSelectionForeground(new java.awt.Color(0, 0, 0));
        jScrollPane1.setViewportView(jTablePedidos);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 310, 1400, 500));
        ...
        loginBtn4.setText("Modificar Pedido");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addComponent(loginBtn4, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1510, 850));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        java.util.Date fechaInicio = fecha1.getDate();
        java.util.Date fechaFin = fecha2.getDate();

        if (rut != null && !rut.isEmpty() && fechaInicio != null && fechaFin != null) {
            DefaultTableModel modelo = consultas.buscarPorClienteYFecha(rut, fechaInicio, fechaFin);
            jTablePedidos.setModel(modelo);
        }else if(fechaInicio != null && fechaFin != null){
             DefaultTableModel modelo = consultas.buscarPorClienteYFecha(fechaInicio, fechaFin);
            jTablePedidos.setModel(modelo);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            consultas.exportarExcel(jTablePedidos);
    ...
    private void loginBtn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtn4ActionPerformed
        // TODO add your handling code here:
        Consulta consultas = new Consulta();
        String Hallulla = jTablePedidos.getValueAt(jTablePedidos.getSelectedRow(), 7).toString();
        ...
        if (selectedRow >= 0) {
            int modelRow = jTablePedidos.convertRowIndexToModel(selectedRow);
